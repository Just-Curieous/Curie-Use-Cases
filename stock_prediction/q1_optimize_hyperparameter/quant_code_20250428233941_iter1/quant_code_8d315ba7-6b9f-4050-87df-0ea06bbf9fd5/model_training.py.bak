...
def save_results(predictions, metrics, training_metrics, config):
    ...
    with open(metrics_file, 'w') as f:  # Changed from 'a' to 'w' to avoid appending to a new file
...
def main(config=None):
    ...
    predictions, training_metrics = run_prediction(common_factors, ret_train_common, config)
    ...
    metrics_file = save_results(filtered_predictions, metrics, training_metrics, config)
