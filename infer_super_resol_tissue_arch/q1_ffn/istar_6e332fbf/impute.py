...
class ForwardSumModel(pl.LightningModule):
    ...
    def __init__(self, lr, n_inp, n_out):
        ...
        with open('rmse_results.txt', 'w') as f:
            ...
            f.write(f'# Latent network: 4 layers of 256 units\n')
            f.write(f'# Output activation: ELU(alpha=0.01, beta=0.01)\n')
    ...
    def training_step(self, batch, batch_idx):
        ...
        if self.current_epoch % 10 == 0 and batch_idx==0: 
            with open('../rmse_results.txt', 'a') as f:
                f.write(f'{self.current_epoch},{rmse:.6f},{current_lr:.6f},{batch_size}\n')
